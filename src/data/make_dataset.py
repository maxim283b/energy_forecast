...
def clean_dataset(input_filepath: str | Path, output_filepath: str | Path) -> Path:
    """Clean a raw dataset and save the interim artifact."""
    ...
    logger.info(f"✅ Очищенные данные сохранены: {output_path}")
...
def main(input_filepath, output_filepath):
    ...
    logger = logging.getLogger(__name__)
    try:
        clean_dataset(input_filepath, output_filepath)
